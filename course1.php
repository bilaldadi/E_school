  ...
  <section class="section main-banner" id="top" data-section="section1">
      ...
      <div class="video-overlay header-text">
          <div class="caption">
              ...
              <h2>Welcome the HTML & CSS course</h2>
      ...
      <div class="col-md-12">
        ...
        <div class="col-md-6">
          <article class="video-item">
            ...
            <figure>
              <a href="https://www.youtube.com/watch?v=gT0Lh1eYk78" class="play"><img src="assets/images/html&css.png"></a>
            </figure>
          </article>
        </div>
      </div>
  ...
  <section class="section video" data-section="section5">
    <div class="container">
      ...
      <div class="col-md-12">
        ...
        <div class="col-md-6 align-self-center">
          <div class="left-content">
            <span>So here we are going to foues in the HTML part </span>
            <h4>HTML</h4>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Cumque rem dolorem nam reprehenderit iure voluptas neque quisquam, laudantium ab magni aspernatur minus amet praesentium. Tempore excepturi earum asperiores, delectus magnam quibusdam. Amet pariatur velit beatae. Recusandae enim illum quasi? Debitis sed eligendi ea similique iste earum expedita totam quae consequatur.</p>
            <br>
          </div>
        ...
        <div class="col-md-6">
          <article class="video-item">
            ...
            <figure>
              <a href="https://www.youtube.com/watch?v=pQN-pnXPaVg" class="play"><img src="assets/images/html.png"></a>
            </figure>
          </article>
        </div>
      </div>
  ...
  <section class="section video" data-section="section5">
    <div class="container">
      ...
      <div class="col-md-12">
        ...
        <div class="col-md-6 align-self-center">
          <div class="left-content">
            <span>So here we are going to foues in the CSS part</span>
            <h4>CSS</h4>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Cumque rem dolorem nam reprehenderit iure voluptas neque quisquam, laudantium ab magni aspernatur minus amet praesentium. Tempore excepturi earum asperiores, delectus magnam quibusdam. Amet pariatur velit beatae. Recusandae enim illum quasi? Debitis sed eligendi ea similique iste earum expedita totam quae consequatur.</p>
            <br>
          </div>
        ...
        <div class="col-md-6">
          <article class="video-item">
            ...
            <figure>
              <a href="https://www.youtube.com/watch?v=1Rs2ND1ryYc" class="play"><img src="assets/images/css.jpeg"></a>
            </figure>
          </article>
        </div>
      </div>
